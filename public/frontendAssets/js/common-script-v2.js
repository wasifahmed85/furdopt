...
// Carousel
    ...
    $(".faq-item").each(function () {
      var $this = $(this);
      $this.find(" > .faq-title").on("click touch", function () {
          $(".faq-item").removeClass("active")
          $(".faq-item .faq-text").slideUp();
          if ($this.find(".faq-text:visible").length) {
              $(".faq-item").removeClass("active")
              $(".faq-item .faq-text").slideUp();
          } else {
              $this.addClass("active")
              $(".faq-item .faq-text").slideUp();
              $this.find(" > .faq-text").slideDown();
          }
      })
    })
    // welfare-commitment 
    var swiper = new Swiper(".welfare-commitment-swiper", {
      loop: true,
      Infinity:true,
      slidesPerView:5,
      spaceBetween: 10,
  ...
  // Featured carousel
  var swiper = new Swiper(".featured-carousel", {
    loop: true,
    slidesPerView:4,
    spaceBetween: 40,
    navigation: {
