...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
     <link type="text/css" rel="stylesheet" href="{{ asset('customer/css/customer-style-v27.css') }}">

    <title>FurDopt email Verify</title>
...
<body>
    ...
    <main class="main-wrap">
        ...
        <header class="header-wrap landing-header">
            ...
            {{--
                                    ...
                                    <li>
                                        <a href="{{ route('f.petlisting.add') }}">
                                            ...
                                            <div class="menu-text">Rehome A Pet</div>
                                        </a>
                                    </li>
  {{--
                                    <li>
    ...
    @endif-->
        ...
        <section class="main-content-wrap">
              <div class="container" style="height: calc(100vh - 300px); padding:40px 15px;">
        <div class="row justify-content-center align-items-center h-100">
            <div class="col-md-8">
                <div class="card border border-warning">
                    <div class="card-header border-warning pt-3 pb-3">{{ __('Verify Your Email Address') }}</div>
                    ...
                    <div class="card-body pt-4 pb-4">
                        ...
                        <form class="d-inline" method="POST" action="{{ route('verification.send') }}">
                            @csrf
                            <button type="submit"
                                class="btn btn-link p-0 m-0 mt-2 align-baseline">{{ __('click here to request another') }}</button>.
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript" src="{{ asset('customer/js/common-scripts-v2.js') }}" defer></script>
