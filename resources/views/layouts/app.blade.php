...
<head>
   ...
   <title>{{ 'MyPawrent | ' . ($title ?? 'My Pawrent') }}</title>
    <link
    ...
    <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
     <link type="text/css" rel="stylesheet" href="{{ asset('customer/css/customer-style-v26.css') }}">
    ...
    @endif-->
        ...
        <footer class="footer-wrap">
            ...
            <div class="copyright-wrap">
                <p>Copyright &copy;2025 <span>Pawrent</span>. All Rights Reserved. Developed by <a href="https://websgoal.com/" target="_blank">Websgoal</a></p>
            </div>
        </footer>
