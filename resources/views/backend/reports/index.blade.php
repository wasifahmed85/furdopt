...
@section('content')
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Listing</th>
                                         <th class="text-center">Pet Owner</th>
 ...
 <td>
                                                <a href="{{ route('f.detail', $pet->pet->slug ?? '') }}" target="_blank">{{ $pet->pet->name ??'' }}</a>
                                                
                                            
                                            </td>

                                            <td class="text-center">{{ $pet->owner->name }}</td>
                                           
                                            <td class="text-center">{{ $pet->details }}</td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a class="btn btn-info btn-sm"
                                                    href="{{ route('admin.pets.edit', $pet->pet->id ?? '') }}"><i
                                                        class="fas fa-edit"></i>
                                                    <span>Edit</span>
                                                </a>
                                             

                                                <form action="{{ route('admin.reports.destroy', $pet->pet->id ?? '') }}"
