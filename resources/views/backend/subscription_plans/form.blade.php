...
@section('content')
                        ...
                        <form role="form" id="submitFromDisable" method="POST"
                            ...
                            <div class="card card-default">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Spotlight Allowed</label>
                                        <input type="text" class="form-control" name="spotlight"
                                            value=" {{ old('spotlight', $subscriptionPlan->spotlight ?? '') }}"
                                            field-attributes="required autofocus">
                                        @error('spotlight')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }} </strong>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="type" class="form-control">
                                            ...
                                            <option value="day"
                                                @isset($subscriptionPlan) {{ $subscriptionPlan->type == 'day' ? 'selected' : '' }} @endisset>
                                                Day</option>
                                            <option value="month"
                                                @isset($subscriptionPlan) {{ $subscriptionPlan->type == 'month' ? 'selected' : '' }} @endisset>
                                                Month</option>
                                        </select>
                                        @error('duration')
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea @isset($subscriptionPlan) @endisset name="descriptions">{{$subscriptionPlan->descriptions}}</textarea>
    ...
    @enderror-->
        ...
        -->
                                        <!--    {{ $subscriptionPlan->can_feature_pets == true ? 'checked' : '' }}
    @endisset>-->
                                    ...
                                    <!--                    @isset($subscriptionPlan)
        -->
                                        <!--        {{ $subscriptionPlan->can_feature_pets == false ? 'checked' : '' }}
    @endisset>-->
                                    ...
                                    <!--                    @isset($subscriptionPlan)
        -->
                                        <!--    {{ $subscriptionPlan->can_top_search_pets == true ? 'checked' : '' }}
    @endisset>-->
                                    ...
                                    <!--                    @isset($subscriptionPlan)
        -->
                                        <!--        {{ $subscriptionPlan->can_top_search_pets == false ? 'checked' : '' }}
    @endisset>-->
