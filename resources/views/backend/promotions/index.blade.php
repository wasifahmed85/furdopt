            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Promotion Package</li>
                    </ol>
                </div>
            </div>
            <!--end::Row-->
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Promotion Package</h3>
                            <a href="{{ route('admin.promotions.create') }}">
                                <h3 class="card-title" style="float: right">Create Promotion Package</h3>
                            </a>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($promotions as $key => $promotion)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $promotion->promotion_name }}</td>
                                            <td class="text-center">{{ $promotion->spotlight }}</td>
                                            <td class="text-center">{{ $promotion->promotion_days }}</td>
                                            <td class="text-center">{{ $promotion->price }}</td>

                                            <td class="text-center">
                                                {{ $promotion->status == 1 ? 'Active' : 'Deactive' }}
                                            </td>
