                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Scams</h3>
                            <a href="{{ route('admin.scams.create') }}">
                                <h3 class="card-title btn btn-secondary" style="float: right; color:#ffffff">Create Scam </h3>
                            </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($scams as $key => $scam)
                                        <tr>
                                            ...
                                            <!--<td>{{ $scam->category->name }}</td>-->
                                            <td>{{ $scam->title }}</td>
                                            <!--<td>{{ $scam->description }}</td>-->
