...
@section('content')
    ...
    <div class="app-content-header">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">scams</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="{{ route('admin.scams.index') }}">scams</a></li>
                        <li class="breadcrumb-item active" aria-current="page">scam Create</li>
                    </ol>
                </div>
            </div>
            <!--end::Row-->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">{{ __((isset($scam) ? 'Edit' : 'Create New') . ' scam') }}
                            </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        ...
                        <form role="form" id="submitFromDisable" method="POST"
                            ...
                            <div class="card card-default">
                                ...
                                <div class="card-body">
                                    ...
                                    <!--    <select name="category_id" required="" id="scam_type" class="form-control">-->
                                    <!--        <option>Select Category</option>-->
                                    <!--        @foreach ($categories as $category)-->
                                    <!--            <option value="{{ $category->id }}"-->
                                    <!--                @isset($scam) {{ $scam->category_id == $category->id ? 'selected' : '' }}@endisset>-->
