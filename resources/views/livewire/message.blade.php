                ...
                <div class="card chat-app">
                    ...
                    <div id="plist" class="people-list">
                        ...
                        <ul class="list-unstyled chat-list mt-2 mb-0">
                            ...
                            <a wire:click="getUser({{ $user->id }})">
                             <li class="clearfix" >
                                 <img src="{{ asset('images/backend') }}/{{ $user->avatar }}" alt="avatar" style="width:30px; height:30px;" />
                                 <div class="about">
                    ...
                    <div class="chat">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#view_info">
                                        @if (isset($sender))
                                        <img src="{{ asset('images/backend') }}/{{ $sender->avatar }}" alt="avatar" />
                                        @endif
                                    </a>
                                    <div class="chat-about">
                                        <h4 class="m-b-0"> <b> @if (isset($sender))
                                            {{ $sender->name }}
                                        @endif </h4></b>
                      ...
                      <a href="javascript:void(0);" class="btn btn-outline-warning"><i class="icon-question"></i></a>
                        ...
                        <div class="chat-history" wire:poll="mountData">
                            <ul class="m-b-0">
                                ...
                                <li class="clearfix">
                                    ...
                                    <img src="{{ asset('images/backend') }}/{{$msg->user->avatar }}" alt="avatar">
                                    <span class="message-data-time">{{ $msg->created_at->diffForHumans() }}</span>
                                    </div>
