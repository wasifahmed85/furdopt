			...
			<div class="common-wrap clear">
				...
				<div class="sign-up">
					<div class="sign-up-text">
					 ...
					 @auth
                            <a href="{{ route('f.petlisting.add') }}" class="btn btn-secondary btn-md" style="font-size:18px"> <i class="plussmall-icon"></i>
                               List your Pet up for Adoption</a>
                        @else
                           <a href="{{ route('f.register') }}" class="btn btn-secondary btn-md" style="font-size:18px"> <i class="plussmall-icon"></i> List your Pet up for Adoption</a>
                        @endauth
			...
			<div class="common-wrap clear">
				<div class="our-story-grid">
					<div class="our-story-text">
						<P>FurDopt is a free, easy-to-use platform dedicated to helping pets find their perfect forever homes. Whether a pet is in a rescue, shelter, or with an individual who can no longer care for them, we believe every pet deserves a loving family that suits their needs and lifestyle.</P>
						<P>We go beyond just rehoming—we focus on matching pets with adopters based on their lifestyle, needs, and expectations. Whether it’s an energetic pup needing an active owner, a senior cat looking for a quiet home, or a family searching for the perfect furry companion, FurDopt ensures the right fit for both the pet and the adopter.</P>
