                         ...
                         <div class="my-profile-content">
                             ...
                             <div class="my-profile-text">
                                 ...
                                 <div class="members-info">
                                     ...
                                     @endif
                                     <p><strong>Phone Number:</strong> <dfn> @if($editdata)<input type="tel" wire:model="phone" value="{{ Auth::user()->phone }}">  @else {{ Auth::user()->phone }} @endif </dfn></p> 
                                     <p><strong>Email:</strong> <dfn> {{ Auth::user()->email }} </dfn></p> 
