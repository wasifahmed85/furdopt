...
<section class="main-content-wrap my-listing-page">
    <!-- Begin hero section -->
    <section class="banner" style="background-image: url({{ asset('customer/img/my-listing/listing-hero.jpg') }});">
    ...
    <div class="my-listing-content">
        <form wire:submit.prevent="UpdateData" class="category-form">
                            ...
                            @else
                                <div class="type-selection-row">
                                    ...
                                    <select wire:model="sub_category_id">
                                        ...
                                        @foreach ($subCategoriesEdit as $subCategory)
                                            <option value="{{ $subCategory->id }}"
                                                @if ($sub_category_id == $subCategory->id) selected @endif>
