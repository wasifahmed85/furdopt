                 ...
                 <div class="my-profile-inner">
                     <div class="my-profile-row">
                         ...
                         <div class="cta-group my-profile-head">
                             <a href="{{ route('f.filter') }}" wire:navigate class="search">Explore Pets</a>
                             ...
                             <div class="my-profile-text">
                                 ...
                                 <div class="members-info">
                                     ...
                                     <p><strong>Phone Number:</strong>
                                         @if ($editdata)
                                             <input type="tel" wire:model="phone" value="{{ Auth::user()->phone }}">
                                         @else
                                             {{ Auth::user()->phone }}
                                         @endif
                                     </p>
                     ...
                     <div class="my-profile-row">
                         ...
                         <ul class="profile-fields">
                             ...
                             <li>
                                 ...
                                 @if ($editdata)
                                     <select wire:model="size">
                                         ...
                                         <option @if ($size = 'Small') selected @endif value="Small">🐾
                                             Small
                                         </option>
                                         <option @if ($size = 'Medium') selected @endif value="Medium">🐕
                                             Medium</option>
                                         <option @if ($size = 'Large') selected @endif value="Large">🐕‍🦺
                                             Large</option>

                                         <option @if ($size = 'No preference') selected @endif
                             ...
                             <li>
                                 ...
                                 @if ($editdata)
                                     <select wire:model="pet_age">
                                         ...
                                         <option @if ($pet_age = 'Baby') selected @endif value="Baby">Baby
                                         </option>
                                         <option @if ($pet_age = 'Young') selected @endif value="Young">Young
                                         </option>
                                         <option @if ($pet_age = 'Adult') selected @endif value="Adult">Adult
                                         </option>
                                         <option @if ($pet_age = 'Senior') selected @endif value="Senior">
                                             Senior</option>
                                 ...
                                 @if ($editdata)
                                     <select wire:model="pet_personality">
                                         ...
                                         <option @if ($pet_personality = 'Couch Potato') selected @endif
                                             value="Couch Potato">🛋️ Couch Potato: Prefers lounging and relaxing;
                                             minimal activity needs.</option>
                                         <option @if ($pet_personality = 'Energetic') selected @endif value="Energetic">⚡
                                             Energetic: Always on the go; loves playtime and adventures.</option>
                                         <option @if ($pet_personality = 'Adaptable') selected @endif value="Adaptable">
                                             ⚖️ Adaptable: Comfortable with both playtime and relaxation; displays a
                                             balanced temperament.</option>
                                         <option @if ($pet_personality = 'No preference') selected @endif
                             ...
                             @if ($editdata)
                                 ...
                                 <li>
                                     <input type="text"
                                         placeholder="(e.g., “Loves outdoor activities,” “Good with other pets,” “Low-maintenance”)"
                                         wire:model="specific_trait_activities">
                             ...
                             @if ($editdata)
                                 ...
                                 <li>
                                     ...
                                     <input type="radio" id="No" value="No" class="radio"
                                         wire:model.live="is_available_pet">
                             ...
                             <li>
                                 @if ($editdata)
                                     <select wire:model="pet_gender">
                                         ...
                                         <option @if ($pet_gender = 'Male') selected @endif value="Male">♂
                                             Male</option>
                                         <option @if ($pet_gender = 'Female') selected @endif value="Female">♀
                                             Female</option>
                                         <option @if ($pet_gender = 'Unknown') selected @endif value="Unknown">❓
                                             Unknown</option>
