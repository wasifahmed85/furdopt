                    ...
                    <form wire:submit.prevent="submit">
                        ...
                        <div class="{{ $currentStep != 1 ? 'displayNone' : '' }}">
                            ...
                            <div class="signup-input-raw">
                                <h4>I am a: <span>*</span></h4>
                                <div class="radio-button">
                                    <input type="radio" id="Individual_owner" name="pet_owner_type"
                                        value="Individual owner" class="radio" wire:model.live="pet_owner_type">

                                    <label class="radio-label" for="Individual_owner">Individual owner</label>

                                    <input type="radio" id="Rehoming_centre" name="pet_owner_type"
                                        value="Rehoming centre" class="radio" wire:model.live="pet_owner_type">
                                    <label class="radio-label" for="Rehoming_centre">Rehoming centre</label>
                            ...
                            @if($pet_owner_type == 'Rehoming centre')
                              <div class="signup-input-raw">
                                <h4>Charity ID <span>*</span></h4>

                                <input type="text" placeholder="Enter Your Charity ID" wire:model="Rehoming_centre_id">
                            ...
                            @endif
                            <div class="signup-input-raw">
                                <h4>I would like to adopt a: <span>*</span></h4>
                                <div class="radio-button">
                                    @foreach ($categories as $category)
                                        <input type="radio" id="dog-{{ $category->id }}" name="Interested"
                                            value="{{ $category->id }}" class="radio" wire:model="interested">
                                        <label class="radio-label"
                                            for="dog-{{ $category->id }}">{{ $category->name }}</label>
                                    @endforeach
