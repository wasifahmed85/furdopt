                    ...
                    <div class="type-selection-item">
                         ...
                         <div class="type-selection-item">
                            ...
                            {{--
                             ...
                             <div class="type-selection-row">
                                ...
                                <div class="form-group @error('special_need') has-error has-error-abs @enderror radio-row">
                                    <label>
                          ...
                          <div class="type-selection-row">
                           ...
                           <div class="type-selection-row">
                            ...
                            <div class="type-selection-row">
                                ...
                                <div class="form-group @error('best_fit_for_home') has-error has-error-abs @enderror radio-row">
                                    <label>
                            ...
                            <div class="type-selection-row">
                                ...
                                <div class="form-group @error('need_outdoor_space') has-error has-error-abs @enderror radio-row">
                                    <label>
                        ...
                        <div class="type-selection-item">
                            ...
                            <div class="gallery-uploads thumbnail-add">
                                ...
                                <input type="file" wire:model="newImages" multiple accept="image/jpeg,image/png,image/jpg,image/gif/webp" required="">
     ...
     @endif                     
                            ...
                            <div class="type-selection-row terms-conditions-wrap">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="submit-button">Submit for rehome </button>
