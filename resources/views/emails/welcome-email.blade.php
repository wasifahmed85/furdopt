            ...
            <table width="600" cellpadding="0" cellspacing="0" style="border: 1px solid #ddd; border-radius: 10px; overflow: hidden;">
              ...
              <tr>
                <td style="padding: 30px 40px; background-color: #ffffff;">
                  ...
                  <p style="font-size: 16px; color: #333;">We’re thrilled to welcome you to <strong>FurDopt</strong> — your go-to place for smart pet safety solutions and peace of mind. Whether you're here to protect your furry friend or explore helpful tools, you're in the right place.</p>
                  ...
                  <p style="font-size: 16px; color: #333;">🎁 <strong>Paw-tip:</strong> Check your dashboard for exclusive member perks.</p>
                  ...
                  <p style="font-size: 14px; color: #777;">If you ever need help, reply to this email or contact our team at <a href="mailto:admin@furdopt.com" style="color: #ff6f61;">admin@furdopt.com</a>.</p>
