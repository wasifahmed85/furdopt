          ...
          <tr>
            <td>
              <h2 style="text-align:center; margin: 0px; padding-bottom: 25px; margin-top: 25px;">
                <span style="color:lightcoral">FurDopt</span></h2>
            </td>
          </tr>
          <tr>
            <td>
              <img src="{{ asset('images') }}/{{ $setting->site_logo }}" height="50px" style="display:block; margin:auto;padding-bottom: 25px; ">
            </td>
          </tr>
          <tr>
            <td style="text-align: center;">
              <h1 style="margin: 0px;padding-bottom: 25px; text-transform: uppercase;">We are find Pets For Your Interest </h1>
              <h2 style="margin: 0px;padding-bottom: 25px;font-size:22px;">Want To List Your Pet</h2>
          ...
          <tr>
            <td style="text-align:center;">
              ...
              <div style="margin-bottom: 25px; font-size: 15px;margin-top:7px;">
                   <a href="{{ route('admin.pets.edit', $pet->id) }}">{{$pet->name}}</a>
