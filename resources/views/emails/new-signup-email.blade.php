                ...
                <table border="0" cellspacing="0" cellpadding="0" style="color:#0f3462; font-family: sans-serif;">
                    ...
                    <tr>
                        <td style="text-align: center;">
                            <h1 style="margin: 0px;padding-bottom: 25px; text-transform: uppercase;">New Member
                                {{ $user->name }} Sign up.</h1>
                            <h2 style="margin: 0px;padding-bottom: 25px;font-size:22px;">Want To Check</h2>
