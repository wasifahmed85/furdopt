                    ...
                    <tr>
                        <td style="padding: 30px 40px; background-color: #ffffff;">
                            ...
                            <p style="font-size: 16px; color: #333;">
                                <strong>Your Subscription plan {{ $subscription->plan->name }} ordered is confirmed and start frombh
                                    {{ \Carbon\Carbon::parse($subscription->start_date)->format('F j, Y') }} and end to
                                    {{ \Carbon\Carbon::parse($subscription->end_date)->format('F j, Y') }}</strong>
                            </p>
                            ...
                            <p style="font-size: 16px; color: #333;">🎁 <strong>Paw-tip:</strong> Check your dashboard
