...
class SubscriptionStartMail extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'subscriptionstart:cron';
    ...
    public function handle()
    {
        ...
        foreach ($subscriptions as $subscription) {
            ...
            Mail::to($user->email)->send(new SubscriptionStartNotificatiton($user, $subscription));
        }
