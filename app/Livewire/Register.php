...
class Register extends Component
{
    ...
    public function submitForm()
    {
        ...
        $user =   User::create([
            ...
            'pet_owner_type' => $this->ad_type,
            'gender' => $this->gender,
            'rehome_type' => $this->rehome_type,
            'Rehoming_centre_id' => $this->Rehoming_centre_id,
            'rehoming_centre' => $this->rehoming_centre,
        ...
        Auth::login($user);
        if($this->ad_type == 'Rehome a Pet')
        {
           return redirect()->route('f.petlisting.add');  
        }
        if($this->ad_type == 'Adopt a Pet')
        {
           return redirect()->route('f.lookingfor');  
        }
